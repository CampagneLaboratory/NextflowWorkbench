...
<model ref="r:eca7b5e4-546f-47a0-8150-d43655cf1011(artifacts)">
  ...
  <node concept="VuPG2" id="1FavoX$xp9K">
    ...
    <node concept="3blhQM" id="5t2Hg$bsS7m" role="3blhQR">
      <ref role="3blhQY" node="5t2Hg$bsS7l" resolve="ElasticlusterConfigTools_Image" />
    </node>
  </node>
  <node concept="2E_JVc" id="5t2Hg$bsS7l">
    <property role="2E_JEh" value="d6dd257e052c" />
    ...
    <node concept="Gyxd7" id="5t2Hg$bsS7p" role="Gyxcj">
      <property role="Gyxfx" value="artifacts" />
