...
public class Process_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_grok3i_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNodeList_grok3i_e0(editorContext, node));
    ...
    editorCell.addEditorCell(this.createConstant_grok3i_j0(editorContext, node));
    editorCell.addEditorCell(this.createRefNodeList_grok3i_k0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_grok3i_l0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_grok3i_m0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_grok3i_n0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNodeList_grok3i_e0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Process_Editor.processOptionsListHandler_grok3i_e0(node, "processOptions", editorContext);
  ...
  private static class processOptionsListHandler_grok3i_e0 extends RefNodeListHandler {
    public processOptionsListHandler_grok3i_e0(SNode ownerNode, String childRole, EditorContext context) {
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_grok3i_a4a(editorContext, node);
    }
    ...
    private EditorCell createConstant_grok3i_a4a(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createRefNodeList_grok3i_h0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Process_Editor.inputsListHandler_grok3i_h0(node, "inputs", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Indent(), false);
  ...
  private static class inputsListHandler_grok3i_h0 extends RefNodeListHandler {
    public inputsListHandler_grok3i_h0(SNode ownerNode, String childRole, EditorContext context) {
      super(ownerNode, childRole, context, false);
    }
    public SNode createNodeToInsert(EditorContext editorContext) {
      SNode listOwner = super.getOwner();
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_grok3i_a7a(editorContext, node);
    }
    public void installElementCellActions(SNode listOwner, SNode elementNode, EditorCell elementCell, EditorContext editorContext) {
      if (elementCell.getUserObject(AbstractCellListHandler.ELEMENT_CELL_ACTIONS_SET) == null) {
        elementCell.putUserObject(AbstractCellListHandler.ELEMENT_CELL_ACTIONS_SET, AbstractCellListHandler.ELEMENT_CELL_ACTIONS_SET);
    ...
    private EditorCell createConstant_grok3i_a7a(EditorContext editorContext, SNode node) {
      EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "<<no input channels>>");
      editorCell.setCellId("Constant_grok3i_a7a");
      Style style = new StyleImpl();
      WorkflowStyles_StyleSheet.apply_EmptyCell(style, editorCell);
      editorCell.getStyle().putAll(style);
      editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_grok3i_j0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "output:");
    editorCell.setCellId("Constant_grok3i_j0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, 0, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNodeList_grok3i_k0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Process_Editor.outputsListHandler_grok3i_k0(node, "outputs", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Indent(), false);
  ...
  private static class outputsListHandler_grok3i_k0 extends RefNodeListHandler {
    public outputsListHandler_grok3i_k0(SNode ownerNode, String childRole, EditorContext context) {
      super(ownerNode, childRole, context, false);
    }
    public SNode createNodeToInsert(EditorContext editorContext) {
      SNode listOwner = super.getOwner();
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_grok3i_a01a(editorContext, node);
    }
    public void installElementCellActions(SNode listOwner, SNode elementNode, EditorCell elementCell, EditorContext editorContext) {
      if (elementCell.getUserObject(AbstractCellListHandler.ELEMENT_CELL_ACTIONS_SET) == null) {
        elementCell.putUserObject(AbstractCellListHandler.ELEMENT_CELL_ACTIONS_SET, AbstractCellListHandler.ELEMENT_CELL_ACTIONS_SET);
    ...
    private EditorCell createConstant_grok3i_a01a(EditorContext editorContext, SNode node) {
      EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "<<no output channels>>");
      editorCell.setCellId("Constant_grok3i_a01a");
      Style style = new StyleImpl();
      WorkflowStyles_StyleSheet.apply_EmptyCell(style, editorCell);
      editorCell.getStyle().putAll(style);
      editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_grok3i_m0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "script:");
    editorCell.setCellId("Constant_grok3i_m0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, 0, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNode_grok3i_n0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, editorContext);
