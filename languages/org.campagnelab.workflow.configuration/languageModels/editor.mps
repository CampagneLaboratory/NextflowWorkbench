...
<model ref="r:30dc0ab7-951f-462f-b5ae-6760525b0724(org.campagnelab.workflow.configuration.editor)">
  ...
  <node concept="24kQdi" id="5KN4KqYQkYf">
    ...
    <node concept="3EZMnI" id="5KN4KqYQkYg" role="2wV5jI">
      ...
      <node concept="3F1sOY" id="1PwW9iwX7yk" role="3EZMnx">
        <ref role="1NtTu8" to="dlwq:1PwW9iwX7uh" />
        <node concept="ljvvj" id="1PwW9iwX7zI" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
        <node concept="lj46D" id="1PwW9iwX7zJ" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
      </node>
